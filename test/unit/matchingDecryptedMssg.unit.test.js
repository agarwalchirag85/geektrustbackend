...
describe("Matching decrypted Message test", () => {
    ...
    it("Should contains kingdome emblem if input are correct ",()=>{
        ...
        finallist = new matchingMessage(decryptedMessage1,kingdomEmblem1,finallist).matching();
        ...
        finallist = new matchingMessage(decryptedMessage2,kingdomEmblem2,finallist).matching();
        ...
        finallist = new matchingMessage(decryptedMessage3,kingdomEmblem3,finallist).matching();
